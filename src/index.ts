...
import { executeScheduledJob as executeScheduledJobRuntime } from "./scheduled-runtime";
 ...
 */
function executeScheduledJob(cron: string, scheduledAt: Date, env: Env): Promise<void> {
  return executeScheduledJobRuntime(cron, scheduledAt, env, {
    runAmbientDigest: runProductionAmbientDigest,
    runDailyReview: runProductionDailyReview,
  });
}
