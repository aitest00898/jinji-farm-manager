...
export interface WeatherDaily { id: string; farmId: string; farmName: string; environment: string; weatherDate: string; condition: string | null; maxTemperatureC: number | null; maxTemperatureAt: string | null; minTemperatureC: number | null; minTemperatureAt: string | null; provider: string; fetchStatus: string; errorCode: string | null; fetchedAt: string | null }
