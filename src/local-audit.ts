...
function baselineState(): LocalAuditState {
  ...
  const ambientPreview: AmbientPreview = {
    cutoffAt: "2026-08-31T04:00:00Z", page: 0, pageSize: 2, total: 3, totalPages: 2, candidateLikeCount: 2, excludedCount: 1, openCandidateCount: 2, processed24hCount: 0, expiredDiagnosticCount: 0, expiredDiagnostics: [], truncated: true, readOnly: true, observabilityAvailable: true,
    recentDigestInvocations: [{ invocationIdShort: "inv-001", scheduledFor: "2026-08-31T04:00:00Z", triggerType: "cron", attemptCount: 1, runStartedAt: "2026-08-31T04:00:01Z", invocationStatus: "completed", errorStage: null, errorClass: null, completedAt: "2026-08-31T04:00:03Z", retentionExpiresAt: "2026-09-07T04:00:00Z", groupsBeforeCleanup: 1, groupsAfterCleanup: 1, perGroupRunsCreated: 1 }],
    recentDigestRuns: [{ runIdShort: "run-001", invocationIdShort: "inv-001", scheduledFor: "2026-08-31T04:00:00Z", triggerType: "cron", attemptCount: 1, runStartedAt: "2026-08-31T04:00:01Z", runStatus: "completed", retryState: "not_needed", deadlineState: "not_recorded", executionDeadline: null, retentionExpiresAt: "2026-09-07T04:00:00Z", stages: { lease: "released", source: "success", prefilter: "candidate_like", ai: "success", validation: "success", reconcile: "success", candidateWrite: "none_required", bufferConsume: "success", delivery: "not_requested" }, errorStage: null, errorClass: null, completedAt: "2026-08-31T04:00:03Z" }],
    rows: [
