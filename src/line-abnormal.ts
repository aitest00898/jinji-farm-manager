...
const ABNORMAL_WORDS = /(?:咳嗽|咳|一直咳|咳得很明顯|咳得很明显|喘|呼吸很喘|臭腳|臭脚|腳很臭|脚很臭|跛腳|跛脚|拉肚子|拉白便|拉綠便|拉绿便|拉血便|白便|綠便|绿便|血便|腹瀉|腹泻|不吃|沒精神|没精神|活動變少|活动变少|活動力下降|生長慢|生長遲緩|長不大|长不大|眼睛腫|眼腫|眼肿|怪怪|異常|异常|故障|壞掉|坏掉|壞|坏|沒動|没动|停電|停电|斷電|断电|漏水|破掉|受損|受损|風吹|淹水|倒塌|水簾|水帘|風扇|风扇|屋頂|屋顶|飼料|饲料|缺料|缺水)/gu;
