...
INSERT OR IGNORE INTO houses
  (id, farm_id, name, normalized_name, capacity, active)
VALUES
  ('house-local-quick-record-b-1', 'farm-local-quick-record-b', '測試B舍', '測試B舍', 1200, 1);
...
VALUES
  ('flock-local-quick-record-1', 'farm-local-quick-record', 'house-local-quick-record-1',
   'QUICK-RECORD-001', '土雞', '2026-08-19', 1000, '2026-11-17', 'active');

INSERT OR IGNORE INTO flocks
  (id, farm_id, house_id, batch_code, breed, chick_in_date, initial_count,
   expected_shipment_date, status)
VALUES
  ('flock-local-quick-record-b-1', 'farm-local-quick-record-b', 'house-local-quick-record-b-1',
   'QUICK-RECORD-B-001', '土雞', '2026-08-19', 1000, '2026-11-17', 'active');
