...
export class ApiClient {
  ...
  discoverDomainRecovery(body: Record<string, unknown> = {}, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-discover${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  dryRunDomainRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-dry-run${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  applyDomainRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-apply${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  dryRunDomainRecoveryBatch(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-batch-dry-run${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  applyDomainRecoveryBatch(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-batch-apply${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  discoverDomainPointInTimeRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-pit-discover${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  dryRunDomainPointInTimeRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-pit-dry-run${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  applyDomainPointInTimeRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/domain-pit-apply${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  discoverFinanceRecovery(body: Record<string, unknown> = {}, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/finance-discover${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  dryRunFinanceRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/finance-dry-run${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
  applyFinanceRecovery(body: Record<string, unknown>, environment: OperationalEnvironment = "production") { return this.request<Record<string, unknown>>(`/api/recovery/finance-apply${queryString({ environment })}`, { method: "POST", body: JSON.stringify(body) }); }
