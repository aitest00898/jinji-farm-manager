...
export type NavIconName = "dashboard" | "organization" | "farms" | "caretakers" | "houses" | "flocks" | "events" | "abnormal" | "finance" | "equity" | "charts" | "ai" | "reminders" | "aliases" | "audit" | "health" | "settings" | "pending" | "system" | "diagnostics" | "pendingDiagnostics" | "testTools" | "technical" | "lineGroups" | "recovery" | "logout";
...
export const NAV_ITEMS = [
  ...
  { key: "recovery", label: "Recovery", description: "資料恢復與 PIT", pageDescription: "以 server Dry Run、dependency group 與 authoritative readback 安全恢復資料。", group: "system", icon: "recovery", primary: false },
