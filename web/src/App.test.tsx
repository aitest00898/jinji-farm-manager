...
describe("Web management safety contract", () => {
  ...
  it("classifies every bounded AI layer without exposing raw internal errors", () => {
    const cases = [
      ...
      ["ai_response_json_no_object_candidate", "response_validation", "AI 回覆格式", "AI 回覆格式不符合系統要求。"],
      ["ai_response_json_object_unterminated", "response_validation", "AI 回覆格式", "AI 回覆格式不符合系統要求。"],
      ["ai_response_json_object_candidate_invalid", "response_validation", "AI 回覆格式", "AI 回覆格式不符合系統要求。"],
      ["ai_response_json_object_candidate_ambiguous", "response_validation", "AI 回覆格式", "AI 回覆格式不符合系統要求。"],
