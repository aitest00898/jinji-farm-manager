...
function FarmsView({ farms, initialFarmId, onCreate, onUpdate, onRecord, canAdmin }: { farms: Farm[]; initialFarmId: string | null; onCreate: (body: Record<string, unknown>) => MutationResult; onUpdate: (id: string, body: Record<string, unknown>, structural: boolean) => MutationResult; onRecord: (farmId: string) => void; canAdmin: boolean }) {
